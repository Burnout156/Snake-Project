...
namespace Codigos {
    ...
    public static class CMDebug
    {
        ...
        public static SpriteGlobal Button(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, int fontSize = 30, float paddingX = 5, float paddingY = 5)
        {
            return SpriteGlobal.CriarBotaoDebugar(parent, localPosition, text, ClickFunc, fontSize, paddingX, paddingY);
        }
