...
namespace Codigos {
     ...
     * */
    public class FuncaoTemporizadora {
        ...
        private static List<FuncaoTemporizadora> timerList; // Holds a reference to all active timers
        private static GameObject initGameObject; // Global game object used for initializing class, is destroyed on scene change

        private static void InitIfNeeded() {
            if (initGameObject == null) {
                initGameObject = new GameObject("FunctionTimer_Global");
                timerList = new List<FuncaoTemporizadora>();
            }
        }
        ...
        public static FuncaoTemporizadora Criar(Action action, float timer) {
            return Create(action, timer, "", false, false);
        }
        public static FuncaoTemporizadora Create(Action action, float timer, string functionName) {
            return Create(action, timer, functionName, false, false);
        }
        public static FuncaoTemporizadora Create(Action action, float timer, string functionName, bool useUnscaledDeltaTime) {
        ...
        public FuncaoTemporizadora(GameObject gameObject, Action action, float timer, string functionName, bool useUnscaledDeltaTime) {
